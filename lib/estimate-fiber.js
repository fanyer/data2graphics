import D3 from 'd3'
import baseConf from './default-config/estimate-fiber.config'
import { bend } from './utils/filter'
import { name2rgba, addOpacity } from './utils/color'
...
export function estimateFiber(parent, config) {
    ...
    var radius = d3.range(min, min + 4 * d + 30, 20)
