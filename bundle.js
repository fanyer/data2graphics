...
/***/ function(module, exports, __webpack_require__) {
	...
	function intakeSugarDistribution(parrent, config1, config2) {
	    ...
	    var line = _d2.default.line().defined(function (d) {
	        return d;
	    }).x(function (d) {
	        return x(d.x);
	    }).y(function (d) {
	        return y(d.y);
	    }).curve(_d2.default.curveBasis);
	    ...
	    var svg = _d2.default.select("svg"),
	        margin = { top: 20, right: 40, bottom: 50, left: 40 },
	        width = +svg.attr("width") - margin.left - margin.right,
	        height = +svg.attr("height") - margin.top - margin.bottom,
	        g = svg.append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")");

	    var formatNumber = _d2.default.format(".1f");

	    var x = _d2.default.scaleLinear().domain([1 - 0.8, 6 + 0.8]).range([0, width]);

	    var y = _d2.default.scaleLinear().domain([0, 7]).range([height, 0]);

	    var xAxis = _d2.default.axisBottom(x).ticks(6).tickSize(5).tickFormat(function (d) {
	        return labels[d - 1];
	    });

	    var yAxis = _d2.default.axisRight(y).ticks(6).tickSize(width).tickFormat(function (d) {
	    ...
	    _d2.default.range(0, 1, 0.02).forEach(function (e, i) {
